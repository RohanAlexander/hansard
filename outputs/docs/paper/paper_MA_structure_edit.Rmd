...
We summarise our results in terms of prime ministers in Table \@ref(tab:primeministersresults) and in terms of elections in Table \@ref(tab:electionsresults). These tables focus on prime ministers and elections that were different to the ones that preceded them.[^listfootnote] A total of XX out of the XX prime ministers had significantly different topic discussions than their predecessor. In terms of elections, XX out of a total of XX elections were significant different to the previous cycle. 
...
Table \@ref(tab:keyeventsresultstable) summarises the days where parliamentary discussion was significantly different from the rest prevailing in that week. XX ADD A BIT OF COMMENTARY HERE XX
