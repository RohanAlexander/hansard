...
institute: Presentation at the Research School of Economics, Australian National University, Canberra, Australia.
...
- Hansard records have been used in other counties but not really at scale in Australia (although others, such as Patrick Leslie, also use them).
...
knitr::include_graphics("../../../figures/topics_example-slides.png")
```
