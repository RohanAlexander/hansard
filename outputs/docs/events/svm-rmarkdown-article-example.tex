...
Cochrane for their helpful suggestions. \textbf{Version as of}: 26
...
There is a large number of ways to statistically consider the effect of
events. Options that would take advantage of the time series nature of
our data include: autoregressive moving average (ARMA) models which are
commonly used in finance to test for structural breaks
...
We consider events in two ways. The first is in the change in the word
...
common across, and so if it was especially prevalent in a particular
...
\begin{figure}
\includegraphics[width=1\linewidth]{/Users/rohanalexander/Documents/phd/hansard/outputs/figures/example_hansard_page} \caption{Example Hansard page - 6 February 1902}\label{fig:unnamed-chunk-1}
\end{figure}
