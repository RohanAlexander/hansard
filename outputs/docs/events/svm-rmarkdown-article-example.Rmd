...
There is much more on topic modelling in the next section because topics are the main data analysed in this paper, but here we briefly discuss the pre-processing steps  of creating the topics.

records, and clean the records using functions from the \texttt{Tidyverse} R package of @Wickham2017, the \texttt{Tidytext} R package of @SilgeRobinson2016 and the [INSERT OTHERS]. The result is a 
