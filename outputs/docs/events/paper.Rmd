...
We summarise our results in terms of elections Table \@ref(tab:electionsresults) and in terms of governments in Table \@ref(tab:governmentsresults). Those tables focus on elections and governments that were different to the ones that preceeded them. 
...
We summarise the periods where parliamentary discussion was significantly different in Table X. **[Oh boy.]**



We summarise our results over time by looking at the standard deviation of sitting period estaimtes, around the mean election effect (Figure \@ref(fig:sigmaelection))
