...
There are a variety of diagnostic measures that can guide the selection of the topics, but there is rarely an obvious best choice and we found it useful to try a few quite different measures before settling on 80 topics. Useful diagnostic measures that we considered include the held-out likelihood, the lower bound, residuals, and semantic coherence (Figures \@ref(fig:topicsdiagnostics)).[^Silgefootnote]
...
Additionally, the tradeoff between exclusitivity and semantic coherence...  (Figure \@ref(fig:topicsexclusivityvscoherence))
