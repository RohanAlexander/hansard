...
elections_results %>%
  kable(booktabs = T, caption = "Elections that were significantly different to the one before") %>%
  kable_styling(font_size = 10) %>% 
...
In the Senate, the PDF for 10 August 1917 may be the wrong one. It says it is for 10 January 1918 on the cover sheet, but there's not an entry for 10 January 1918.
