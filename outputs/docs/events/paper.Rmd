...
abstract: |
  We use a structural text model to explore the impact of various events on what was said in Australian state and Commonwealth parliaments from the year they were established (mid-1800s for most of the states, and 1901 for the Commonwealth) through to 2017. We find that 1) [TBD]; 2) [TBD]; and 3) [TBD].
