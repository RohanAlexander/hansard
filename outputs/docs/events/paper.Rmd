...
The remainder of the results refer to a topic model which had a total of 40 distinct topics define. **ROHAN PLEASE ADD WHY 40**
...
top_words %>% 
  kable(booktabs = T, caption = "Top words associated with each topic") %>%
