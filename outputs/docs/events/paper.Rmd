...
[^datasourcefootnote]: We have made our dataset available via the R package \texttt{hansardr}. R users can use the devtools package [@Wickham2018] to install it from: https://github.com/RohanAlexander/hansardr. Users of other languages can download the daily CSV files from the data-raw folder of that repository.
