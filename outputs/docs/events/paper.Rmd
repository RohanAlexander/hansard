...
```{r asdf, echo=FALSE, fig.cap="Example Hansard page - 6 February 1902", out.width = '90%'}
...
Comparing the sitting days to the dates that we have suggests some issues with the dataset (Table \@ref(tab:missingdays)).)
...
Positive means we are missing some, negative means we have too many.
...
**[TBD].** Insert graph of stop words over time. 
