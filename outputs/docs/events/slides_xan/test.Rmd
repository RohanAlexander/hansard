...
knitr::include_graphics("../../../figures/topics_example-slides.pdf")
```
...
```{r wartopicsgraph, cache = TRUE, echo = FALSE, out.width = '100%'}
...
```{r mugov, cache = TRUE, echo = FALSE, out.width = '100%'}
...
```{r muelection, cache = TRUE, echo = FALSE, out.width = '100%'}
...
key_events_results %>%
  kable(caption = "Days that were significantly different to other days in their sitting period") %>%
  kable_styling(font_size = 10)
...
```{r muelectionmenziesholt, cache = TRUE, echo = FALSE, out.width = '100%'}
knitr::include_graphics("../../../figures/mu_election-differences-menziesholt.pdf")
```
...
```{r muelectionwhitlam, cache = TRUE, echo = FALSE, out.width = '100%'}
knitr::include_graphics("../../../figures/mu_election-differences-whitlam.pdf")
```
...
```{r muelectionhoward, cache = TRUE, echo = FALSE, out.width = '100%'}
knitr::include_graphics("../../../figures/mu_election-differences-howard.pdf")
```
