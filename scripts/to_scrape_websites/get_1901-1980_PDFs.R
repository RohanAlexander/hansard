#### Preamble ####
# Purpose: This file gets Australian Hansard PDF files from the parliament website.
# Author: Rohan Alexander
# Email: rohan.alexander@anu.edu.au
# Last updated: 31 August 2018
# Prerequisites: Need a list of csvs to walk through - URLs_for_00s-80s_PDFs.csv
# To do:
...
data_to_scrape <- read_csv("scripts/to_scrape_websites/URLs_for_00s-80s_PDFs.csv")
...
# save_name <- c("data/NOT_URL.pdf", save_name[3:4]) # testing the safety behaviour
