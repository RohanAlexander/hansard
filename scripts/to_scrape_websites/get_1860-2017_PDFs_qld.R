#### Preamble ####
# Purpose: This file gets Queensland Hansard PDF files from the parliament website.
# Author: Rohan Alexander
# Email: rohan.alexander@anu.edu.au
# Last updated: 17 September 2018
# Prerequisites: Need a list of csvs to walk through - URLs_for_QLD.csv
# To do: -
...
data_to_scrape <- read_csv("scripts/to_scrape_websites/addresses/URLs_for_QLD.csv")
