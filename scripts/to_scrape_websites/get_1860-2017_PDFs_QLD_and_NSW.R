...
# Prerequisites: Need a list of csvs to walk through - URLs_for_QLD_and_VIC.csv
# To do: -
...
data_to_scrape <- read_csv("scripts/to_scrape_websites/addresses/URLs_for_QLD_and_VIC.csv")
