#### Preamble ####
# Purpose: This file gets Queensland index PDF files for the senate from the parliament website.
...
data_to_scrape <- read_csv("scripts/to_scrape_websites/addresses/addressesforqldindices.csv")
