...
use_this_path_to_get_pdfs  <- "outputs/test/abbyy"
# use_this_path_to_get_pdfs  <- "/Volumes/Hansard/pdfs/federal/hor"
...
use_this_path_to_save_csv_files  <- "outputs/test/run_1_output"
...
get_text_from_PDFs <-
  function(name_of_input_PDF_file,
    ...
    name_of_input_PDF_file <- "outputs/test/abbyy/hor-1971-03-30.txt" # uncomment for testing
    # name_of_input_PDF_file <- "inputs/for_testing_senate_pdf/1901-06-06.pdf" # uncomment for testing
    txt_document <- read_lines(name_of_input_PDF_file)
    
    # Convert to tibble
    pdf_document_tibble <- tibble(text = txt_document)
    rm(pdf_document)
