...
# use_this_path_to_get_csvs  <- "/Volumes/Hansard/parsed/federal/senate/run_4_output"
use_this_path_to_get_csvs <- "/Volumes/Hansard/parsed/federal/hor/run_4_output"
...
file_tibble <- file_tibble %>%
  mutate(the_year = filename,
         the_year = str_replace(the_year, "/Volumes/Hansard/parsed/federal/senate/run_4_output/", ""),
         the_year = str_replace(the_year, "/Volumes/Hansard/parsed/federal/hor/run_4_output/", ""),
...
# use_this_path_to_save_csvs  <- "/Volumes/Hansard/parsed/federal/senate/run_5_output"
use_this_path_to_save_csvs <- "/Volumes/Hansard/parsed/federal/hor/run_5_output"
